...
The Media page is a title-and-link directory for eight dedicated pages under `media/`: profile, certificates, courses, experience, gallery, documents, posts and links. Contact has its own `contact.html` page. Explicit legacy fragment redirects preserve saved links to the former single-page sections.
